...
namespace RUSO
{
	public partial class Exportadores : Form
	{
		...
		string level;
		string operacion;
		public Exportadores(string user, string nivel)
		{
			InitializeComponent();
			label27.Text = user;
			llenartabla();
		...
		private void Exportadores_FormClosed(object sender, FormClosedEventArgs e)
		{
			Application.Exit();
		}
		...
		private void Exportadores_Load(object sender, EventArgs e)
		{
