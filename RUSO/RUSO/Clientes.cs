...
namespace RUSO
{
	public partial class Clientes : Form
	{
		...
		{
			string query = "INSERT INTO clientes(primer_nombre, segundo_nombre, primer_apellido,"+
			" segundo_apellido, dpi, sexo, fecha_nacimiento, direccion) VALUES ('"+nom1.Text+"','"+nom2.Text+"','"+apel1.Text+"','"+apel2.Text+"',"
			+"'"+dpi.Text+"','"+comboBox1.Text+"','"+dateTimePicker1.Text+"','"+dir.Text+"')";
			operacion = "INSERT INTO clientes(primer_nombre, segundo_nombre, primer_apellido," +
			" segundo_apellido, dpi, sexo, fecha_nacimiento, direccion) VALUES (" + nom1.Text + "," + nom2.Text + "," + apel1.Text + "," + apel2.Text + ","
			+ "" + dpi.Text + "," + comboBox1.Text + "," + dateTimePicker1.Text + "," + dir.Text + ")";
		...
		{
			string query = "DELETE FROM clientes  WHERE  cod_cliente =" + dataGridView1.CurrentRow.Cells[0].Value.ToString();
			operacion = "DELETE FROM clientes  WHERE  cod_cliente =" + dataGridView1.CurrentRow.Cells[0].Value.ToString();
			databaseConnection.Open();
			MySqlCommand consulta = new MySqlCommand(query, databaseConnection);
			try
			{
		...
		private void button3_Click(object sender, EventArgs e)
		{
			if (dataGridView1.SelectedRows.Count == 1)
			{
				...
				dir.Text = dataGridView1.CurrentRow.Cells[8].Value.ToString();
			}
