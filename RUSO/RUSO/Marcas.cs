...
namespace RUSO
{
	public partial class Marcas : Form
	{
		...
		{
			string query = "UPDATE marcas SET marca ='" + textBox2.Text + "' WHERE  cod_marca =" + dataGridView1.CurrentRow.Cells[0].Value.ToString();
			operacion = "UPDATE marcas SET marca =" + textBox2.Text + " WHERE  cod_marca =" + dataGridView1.CurrentRow.Cells[0].Value.ToString();
			databaseConnection.Open();
			MySqlCommand consulta = new MySqlCommand(query, databaseConnection);
			try
			{
