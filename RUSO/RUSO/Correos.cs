...
namespace RUSO
{
	public partial class Correos : Form
	{
		...
		string level;
		string operacion;
		public Correos(string user, string nivel)
		{
			InitializeComponent();
			label27.Text = user;
			llenartabla();
		...
		private void Correos_FormClosed(object sender, FormClosedEventArgs e)
		{
			Application.Exit();
		}
		...
		private void Correos_Load(object sender, EventArgs e)
		{
